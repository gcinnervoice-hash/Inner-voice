  ...
  return (
    <div className="px-6 py-4">
      <div className={`rounded-xl shadow-lg backdrop-blur-sm border transition-all duration-300 ${themeClasses.settingsPanelBg}`}>
        ...
        >
          <div className="flex items-center gap-2">
            <span className={`${themeClasses.themeIcon} text-lg`} aria-hidden="true">
              {themeClasses.themeIcon}
            </span>
            <span className={`font-character font-bold transition-all duration-300 ${themeClasses.primaryText} ${themeClasses.fontHeading}`}>Nature Theme</span>
            <span className={`${themeClasses.fontCaption} opacity-70 ${themeClasses.secondaryText}`}>
              ({themeClasses.themeName})
            </span>
          </div>
          <div className={`transform transition-transform ${isThemeExpanded ? 'rotate-180' : ''}`}>
